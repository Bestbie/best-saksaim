  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
        <li class="nav-item">
          <a href="<?= base_url('user/dashboard') ?>" class="nav-link <?= (isset($activeMenu) && $activeMenu === 'dashboard') ? 'active' : '' ?>">
        ...
        <li class="nav-item">
            <a href="<?= base_url('user/evaluations/index') ?>" class="nav-link <?= (isset($activeMenu) && $activeMenu === 'evaluations') ? 'active' : '' ?>">
